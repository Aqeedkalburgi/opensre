...
from interactive_shell.state import history as history_module
from interactive_shell.state.history.policy import RedactingFileHistory
...
def _redirect_history_path(monkeypatch: pytest.MonkeyPatch, target: Path) -> None:
    ...
    from interactive_shell.state.history import storage as history_storage
