"""Shell agent turn entry points for the interactive OpenSRE shell.
...
module keeps only the shell entry points that adapt runtime/session dependencies
into the decoupled engine:
